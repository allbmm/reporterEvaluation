...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        ...
        cv2.putText(image, f'minus point: {float(grade_min1+grade_min2)}', (int(20*width_ratio),int(550*height_ratio)), cv2.FONT_HERSHEY_SIMPLEX, 1.5*width_ratio, (0,255,0), 2)
